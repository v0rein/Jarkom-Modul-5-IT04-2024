...
#iptables -A INPUT -s 192.235.0.128/25 -m time --timestart 08:00 --timestop 21:00 -j ACCEPT
#iptables -A INPUT -s 192.235.1.0/24 -m time --timestart 03:00 --timestop 23:00 -j ACCEPT
